...
import { UsersTechProgress } from "~/types/typings.td"

const RankProgress = ({ usersTechProgress }: { usersTechProgress: UsersTechProgress }) => {
  return (
    <div className="lg:col-span-4 2xl:col-span-2 bg-cleaner-gray relative rounded-3xl lg:px-6 2xl:px-8 py-2">
      <div className="flex items-center gap-3">
        <h2 className="font-semibold xl:text-2xl text-dark-gray tracking-tight">Progresso de Ranking</h2>
