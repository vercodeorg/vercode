...
const Status = (props: TypeProps) => {
  ...
  return (
    <div
      className={`px-4 py-1 rounded-full flex items-center justify-center ${getColor(props.statusName!)}`}
    >
      <span className="font-medium lg:text-sm 2xl:text-base text-white">
        {props?.statusName}
      </span>
    </div>
  );
