                        ...
                        <ModalContent>
                            {(onClose) => (
                                <>
                                    ...
                                    <ModalBody>
                                        Você tem certeza que deseja desbloquear esse projeto por {props.unlockCost} coins ?
                                    </ModalBody>
                                    <ModalFooter>
                                        <Button color="danger" variant="light" onPress={onClose}>
                                            Cancelar
                                        </Button>
                                        <Button color="primary" onPress={onClose} onClick={handleUnlockProject}>
                                            <Link href={url}>
                                                Desbloquear
                                            </Link>
                                        </Button>
                    ...
                    <ModalContent>
                        {(onClose) => (
                            <>
                                {unlocked === true && (
                                    <>
                                        <ModalHeader className="flex flex-col gap-1">Projeto desbloqueado com sucesso!</ModalHeader>
                                        <ModalBody>
                                ...
                                {unlocked === false && (
                                    <>
                                        <ModalHeader className="flex flex-col gap-1">Não é possível realizar essa operação!</ModalHeader>
                                        <ModalBody>
                                            Você não tem coins sulficientes para desbloquear o projeto!
                                        </ModalBody>
                                        <ModalFooter>
                                            <Button color="danger" variant="light" onPress={onClose}>
                                                <Link href={url}>
