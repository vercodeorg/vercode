            ...
            {(onClose) => (
              <>
                    ...
                    <ModalBody>
                      ...
                      <div className="flex flex-col ml-8">
                        <div className="flex items-center">
                          <span className="font-semibold text-base text-[#F0B40D]">
                            + {props.userExercise?.exercise.coinsToWin}
                          </span>
                          <div className="w-7">
                        ...
                        <span className="font-medium text-base text-dark-gray">
                          + {props?.userExercise?.exercise.xpToWin}xp
                        </span>
                        <Technology
                          technology={
                            props?.userExercise?.exercise.technologies
                          }
                          xpPoints={props?.userExercise?.exercise.xpToWin}
                        />
                      </div>
                    </ModalBody>
                    <ModalFooter>
                ...
                {success === false && (
                  <>
                    <ModalHeader className="flex flex-col gap-1">
                      Ops! Sua resposta não está correta.
                    </ModalHeader>
                    <ModalBody>
                      <div className="w-full">
                        ...
                        <h2 className="text-lg text-blue-800">
                          Não desanime, você consegue! Tente novamente
                        </h2>
                      </div>
                    </ModalBody>
                    <ModalFooter>
