  ...
  return (
    <div className="lg:col-span-4 2xl:col-span-2 bg-cleaner-gray relative rounded-3xl lg:px-6 2xl:px-8 py-6">
      ...
      <div className="px-5 py-1 flex items-center gap-4">
        ...
        <div className="">
          <h3 className="font-extrabold text-dark-gray xl:text-xl">{badge.name}</h3>
          <span className="font-semibold text-medium-gray lg:text-sm 2xl:text-base">RANK - LV {user.usersPoints[0].rankProgress.level}</span>
        </div>
      </div>
