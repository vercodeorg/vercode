...
const Register = () => {
    const [userFormData, setUserFormData] = useState<IUserFormData>({ email: "", username: "", password: "" });
                    ...
                    <form>
                        <div className="flex flex-col gap-4">
                            <Input
                                ...
                                label="Email"
                                variant="bordered"
                                value={userFormData.email} type="text" />
                            <Input
                                onChange={handleUsernameChange}
                                labelPlacement="inside"
                                label="Username"
                                variant="bordered"
                                value={userFormData.username} type="email" />
                            <Input
                        ...
                        <div className="flex flex-col mt-5 gap-5">
                            ...
                            <Button onClick={handleSubmit} className="text-base" color="primary">
                                Registrar
                            </Button>
                        </div>
                    </form>
